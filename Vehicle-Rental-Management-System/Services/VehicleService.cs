    ...
    public class VehicleService
    {
        ...
        public bool AddVehicle(Vehicle vehicle)
        {
            try
            {
                int result = DatabaseHelper.ExecuteStoredProcedure("AddVehicle",
                    ...
                    DatabaseHelper.CreateParameter("@p_categoryName", vehicle.CategoryName, MySqlDbType.VarChar),
        ...
        private Vehicle MapToVehicle(MySqlDataReader reader)
        {
            return new Vehicle
            {
                ...
                CategoryName = reader["Category"] != DBNull.Value ? reader["Category"].ToString() : null,
